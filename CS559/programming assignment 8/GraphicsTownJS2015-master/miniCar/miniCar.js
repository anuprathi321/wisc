...
grobjects.push(new Cube("cube1",[-5,0.2, 4],1, 0, 0) );
grobjects.push(new Cube("cube1",[-6,0.2,1],1, 0, 0) );
grobjects.push(new Cube("cube1",[-4,0.2,2],1, 0, 0) );
grobjects.push(new Cube("cube1",[0,0.2,-4],1, 0, 0) );
grobjects.push(new Cube("cube1",[3,0.2,-4],1, 0, 0) );
